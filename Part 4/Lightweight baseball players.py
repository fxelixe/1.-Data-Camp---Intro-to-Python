...
1. Create a boolean numpy array: the element of the array should be True if the corresponding baseball player's BMI is below 21.
   You can use the < operator for this. Name the array light.
2. Print the array light.
3. Print out a numpy array with the BMIs of all baseball players whose BMI is below 21.
